...
| - 10.1.0.0/16   | 10.1.0.0–10.1.255.255  | DMVPN-хаб             |
...
| Устройство   | Интерфейс     | Адрес       | Маска |
|--------------|---------------|-------------|-------|
| Technical    | e0/0          | 10.0.0.30   | 30    |
| Technical    | e0/1          | 10.0.0.18   | 30    |
| Technical    | e0/2          |             | 30    |
| Technical    | e0/3          |             | 30    |
| Technical    | loopback      | 10.2.0.3    | 32    |
...
| Устройство   | Интерфейс     | Адрес       | Маска |
|--------------|---------------|-------------|-------|
| Director     | e0/0          | 10.0.0.54   | 30    |
| Director     | e0/1          | 10.0.0.46   | 30    |
| Director     | e0/2          |             | 30    |
| Director     | e0/3          |             | 30    |
| Director     | loopback      | 10.2.0.8    | 32    |
...
| Kitron_RR   | loopback  | 172.20.255.3| 32    |
...
| R18         | loopback  | 172.20.255.1| 32    |

| Устройство  | Интерфейс | Адрес       | Маска |
|-------------|-----------|-------------|-------|
| R26         | e0/0      | 172.20.0.9  | 30    |
| R26         | e0/1      | 172.20.0.13 | 30    |
| R26         | e0/2      | 172.20.0.17 | 30    |
| R26         | loopback  | 172.20.255.2| 32    |
...
| R27         | loopback  | 172.20.255.3| 32    |

| Устройство  | Интерфейс | Адрес       | Маска |
|-------------|-----------|-------------|-------|
| R28         | e0/0      | 172.20.0.14 | 30    |
| R28         | e0/1      | 172.20.0.29 | 30    |
| R28         | loopback  | 172.20.255.4| 32    |

| Устройство  | Интерфейс | Адрес       | Маска |
|-------------|-----------|-------------|-------|
| R35         | e0/0      | 192.71.0.5  | 30    |
| R35         | e0/1      | 172.20.0.30 | 30    |
| R35         | e0/2      | 172.20.0.26 | 30    |
| R35         | loopback  | 172.20.255.5| 32    |

| Устройство  | Интерфейс | Адрес       | Маска |
|-------------|-----------|-------------|-------|
| Triada_RR   | e0/0      | 172.20.0.18 | 30    |
| Triada_RR   | e0/1      | 172.20.0.22 | 30    |
| Triada_RR   | loopback  | 172.20.255.6| 32    |
