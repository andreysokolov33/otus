...
Предполагается, что система СКУД работет на статических адресах, но в PT нет подходящего элемента под СКУД, поэтому на коммутаторах просто проведен VLAN СКУДа, но адрес назначен только на сам сервер СКУД.
...
| Серверная | FTP | 80 | 10.10.10.30 | 10.10.10.1 |
...
| Core Layer | CORE 1 | Gi1/0/4 | -  | 109.245.17.10 | - |
| Core Layer | CORE 1 | Gi1/0/5 | -  | 89.215.20.70 | - |
...
| Core Layer | CORE 2 | Gi1/0/4 | - | 109.245.17.14 | - |
| Core Layer | CORE 2 | Gi1/0/5 | -  | 89.215.20.66 | - |
